...
public class GameManager : MonoBehaviour
{
    ...
    // Ya no se usa esta variable de longitud de láser
    //public float laserLength = 40f; 
    public float invincibleRadius = 2f;
    [SerializeField]
    ...
    [Range(0f, 1f)]
    [SerializeField]
    public float laserFrequency = 0.1f; // se cambió a public para acceder desde el UI para pruebas
    [Range(0f, 1f)]
    [SerializeField]
    public float magnetFrequency = 0.1f; // se cambió a public para acceder desde el UI para pruebas
    [Range(0, 4)]
    public int armorUnits = 0;
